...
generate_noise_exp2(seed_id = 2002102,out_pth = noise_detection_dir,n_noises = 500)

# generate noise for MOT

generate_noise_exp2(seed_id = 2002103,out_pth = noise_detection_dir,n_noises = 500)

# Generate protocols for detection
set.seed(1902244)

# Generate gabor for detection exp

generate_gabor_exp2(out_dir = gabor_detection_dir, file_name = "gabor_raw.png")
