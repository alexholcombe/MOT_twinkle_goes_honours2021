...
def openMyStimWindow(): #make it a function because have to do it several times, want to be sure is identical each time
    myWin = visual.Window(monitor=mon,size=(widthPix,heightPix),allowGUI=allowGUI,units='pix',color=bgColor,colorSpace='rgb',fullscr=fullscr,
...
# Setup the Window
win = visual.Window(
    size=[widthPix, heightPix], fullscr=True, screen=0, 
    winType='pyglet', allowGUI=False, allowStencil=False,
    monitor=monitorname, color=bgColor, colorSpace='rgb',
...
if expInfo['frameRate'] != None:
	...
	print('Error: could not measure frameRate with win.getActualFrameRate()') #AOH

#End screen and window testing and setup
