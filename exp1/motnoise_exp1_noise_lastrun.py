...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\filip\\Downloads\\motnoise\\exp1\\motnoise_exp1_noise_lastrun.py',
...
text_2 = visual.TextStim(win=win, name='text_2',
    text='V tomto experimentu bude vaším úkolem sledovat pohybující se objekty. V každém opakování se vám zobrazí 8 statických objektů, přičemž 4 z nich se označí (budou blikat). Po 2 sekundách objekty stanou nerozlišitelnými a rozpohybují se. Vaším úkolem je sledovat ty původně označené.\n\nPo skončení pohybu kliknete myší ty objekty, které byly původně označené\n\nStiskněte mezerník pro pokračování..',
    font='Arial',
...
text_3 = visual.TextStim(win=win, name='text_3',
    text='Nejprve následuje zácvik (12 opakování). Uvidíte 3 typy obtížnosti od nejlehčí po nejtěžší',
    font='Arial',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
text_5 = visual.TextStim(win=win, name='text_5',
    text='Nyní následuje samotný experiment\n\n\n\n\nStiskněte mezerník',
    font='Arial',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
for thisPractice_trial in practice_trials:
    ...
    T = motbox.Track()
    T.load_from_csv(track_filename, delim = ',')
