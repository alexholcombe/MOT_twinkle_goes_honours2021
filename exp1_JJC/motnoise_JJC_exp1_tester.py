...
viewdist = 30 #cm
scrn=1 #0 to use main screen (or second screen with mirroring), 1 to use external screen connected to computer
widthPix = 1280
heightPix = 1024
...
for thisPractice_trial in practice_trials:
    ...
    track_filename = '75Hz_trajectories/T%03d.csv' % trajectory_id
    ...
    while continueRoutine:
        ...
        if t >= 0 and t <= cue_time:
            ...
            for i1 in range(nTargets):
                P.objects[0].size = size_normal * size_coef
