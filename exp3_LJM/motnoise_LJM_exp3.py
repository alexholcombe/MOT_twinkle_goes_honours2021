...
expName = 'noiseMot_exp3_noise'  # from the Builder filename that created this script
...
text_2 = visual.TextStim(win=win, name='text_2',
    text='In each trial, there will be 2 objects, which will move towards the center of the screen, then disappear. You will then need to press DOWN if you thought they disappeared before passing the red cross, or UP if you thought the objects disappeared after passing the red cross.\n\nKeep your eyes on the red cross whenever it is visible.\n\nPress space to continue',
    font='Arial',
...
text_5 = visual.TextStim(win=win, name='text_5',
    text='Nice! You will be reminded of the instructions throughout the experiment: Press DOWN if you thought the objects disappeared before passing the red cross, or UP if you thought the objects disappeared after passing the red cross.\n\nKeep your eyes on the red cross whenever it is visible.\n\nPress Y when you are ready to begin the real trials.',
    font='Arial',
    pos=(0, 0), height=20, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
nextText = visual.TextStim(win=win, name='text_4',
    text='blank',
    font='Arial',
    pos=(0, -100), height=20, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
    depth=0.0);
...
for trialN in range(conditionInfo['nTrials']):
    ...
    if timeForTrialsRemainingMsg and autopilot == False:
        ...
        progressMsg = 'Reminder: Press DOWN if you thought the objects disappeared before passing the red cross, or UP if you thought the objects disappeared after passing the red cross.\n\nKeep your eyes on the red cross whenever it is visible.\n\nCompleted ' + str(trialN*8) + ' of ' + str(conditionInfo['nTrials']*8) + ' trials. Feel free to take a break!'
